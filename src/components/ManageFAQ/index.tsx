//Admin - //Enter new FAQ, Manage Existing FAQs
 ...
 {/* Enter NEW FAQ */}
                    ...
                    <Select
                        data={[
                            ...
                            { label: "PRODUCTS AND INVENTORY", value: "PRODUCTS AND INVENTORY" },
            ...
            <Box
                style={{ border: "2px solid black", width: "100%", height: "55vh", padding: "10px", marginTop: '50px', marginBottom: '50px' }}
            >
