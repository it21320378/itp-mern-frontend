//Admin - PDF only //generate report, Pdf render
import {
    StyleSheet,
    Document,
    Text,
...
//generating PDF
export const AllTicketsPDF = ({ data }: any) => {
                    ...
                    <Image src={logo} style={styles.logo} />
                            ...
                            <View style={styles.table}>
                                <View style={styles.tableRow}>
                                    <View style={styles.HeaderCol}>
                                        <Text style={styles.headerFont}>Ticket Status</Text>
                                    </View>
                                    <View style={styles.HeaderCol}>
                                        <Text style={styles.headerFont}>Ticket Id</Text>
                                    </View>
                                    <View style={styles.HeaderCol}>
                                    ...
                                    <View style={styles.HeaderCol}>
                                        <Text style={styles.headerFont}>Category</Text>
                                    </View>
                                    <View style={styles.HeaderCol}>
                                        <Text style={styles.headerFont}>Issue Subject</Text>
                                    </View>
                                ...
                                {data !== null
                                    ? data.map((data: any, i: any) => (
                                        <View key={i} style={styles.tableRow}>
                                            ...
                                            <View style={styles.tableCol}>
                                                <Text style={styles.tableCell}>{data.ticketId}</Text>
                                            </View>
                                            <View style={styles.tableCol}>
                                            <Text style={styles.tableCell}>{new Date(data.date).toLocaleDateString("en-GB").split("T")[0]}</Text>
                                            </View>
                                            <View style={styles.tableCol}>
                        ...
                        <View>
                            <Text style={styles.copyright}>
                                ...
                                developed by Articrafts development team. The use, reproduction, distribution, or
                                modification of this document or its content without prior written
                                permission from Articrafts is strictly
